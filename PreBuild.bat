...
xcopy "dist\Data" "%2\SkyrimSE" /exclude:xcopy_exclude.txt /i /s /y
xcopy "dist\Data" "%2\SkyrimVR" /exclude:xcopy_exclude.txt /i /s /y
xcopy "dist\SkyrimSE" "%2\SkyrimSE" /i /s /y
xcopy "dist\SkyrimVR" "%2\SkyrimVR" /i /s /y
